...
import { priorityData, statusData, TaskPriority, TaskStatus } from '~/contracts/constant'
...
const UpdateTaskDetailModal = ({ title, description, priority, status, handleRefresh, id }: ITaskDetailModal) => {
  ...
  const [titleValidation, setTitleValidation] = useState(title)
            ...
            {(onClose) => (
              <>
                ...
                <ModalFooter>
                  ...
                  <Button isDisabled={titleValidation === ''} type='submit' color='primary' onPress={onClose}>
                    Submit
                  </Button>
                </ModalFooter>
              </>
